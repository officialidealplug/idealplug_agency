...
import { routeStyle, backend, companyName, getCurrentDate, getCurrentTime, extractBaseTitle, storeButtonInfo, clientInfoName } from '@/config/utils'
import { IClientInfo, IButtonResearch, INews } from "@/config/interfaces";
...
const Footer = () => {
    ...
    const setLoadingModal = useLoadingModalStore(state => state.setLoadingModal);
      ...
      const subNewsLetter = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        const info: IButtonResearch = {
            ...
            Region: clientInfo?.ipData?.region!,
            Country: clientInfo?.ipData?.country!,
            Button_Name: "subNewsLetter()",
            Button_Info: `Clicked submit newsletter in footer`,
            Page_Title: extractBaseTitle(document.title),
            Page_URL: routerPath,
            Date: getCurrentDate(),
            Time: getCurrentTime(),
    ...
    return (
        <footer className={`${styles.footer} ${routeStyle(routerPath, styles)}`}>
           <div className={styles.upper_footer}>
                <div className={styles.contact_section}>
                    ...
                    <span className={styles.brief}>
                        We are committed to providing high-quality service, effective products that support your business and everyday routine.
                    </span>
           ...
           <div className={styles.lower_footer}>
            <div className={styles.footer_menu}>
                ...
                <button onClick={(e) => viewFooterNav(e, "services")}><span>Services</span></button>
                <button onClick={(e) => viewFooterNav(e, "projects")}><span>Projects</span></button>
